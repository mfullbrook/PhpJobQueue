...
class TestCase extends \PHPUnit_Framework_TestCase
{
    ...
    protected function replaceFunction($name, $args = '', $code = '')
    {
        ...
        $code = "\Mcf\PhpJobQueue\TestCase::functionCalled(__FUNCTION__); $code";
    ...
    {
        return $this->getMockBuilder('Mcf\\PhpJobQueue\\Storage\\StorageInterface')
    ...
    {
        return $this->getMockBuilder('Mcf\\PhpJobQueue\\Storage\\Redis')
            ->disableOriginalConstructor()
            ->setMethods($methods)
            ->getMock();
    }
